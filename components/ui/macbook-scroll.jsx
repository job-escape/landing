...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ref={ref}
      className="scale-[0.35] md:min-h-[200vh] -mt-60 flex flex-col items-center py-0 md:py-96 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  sm:scale-50 bg-background">
      {/* <motion.h2
        style={{
    ...
    (<div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        {/* <Image
         ...
         <img src="/screenshot.png" alt="aceternity logo" className="absolute inset-0 h-full w-full rounded-lg object-cover object-left-top" />
      </motion.div>
    </div>)
  );
};
